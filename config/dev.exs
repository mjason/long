...
config :long, LongWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "MA4YM2VCDfxay7PY9BXVVIHhGvMxQj6sA8w/bpCJm5UtU6pakhVeEKEon0KTpxsG",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:long, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:long, ~w(--watch)]}
  ]
...
config :long, LongWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/long_web/router\.ex$"E,
      ~r"lib/long_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
