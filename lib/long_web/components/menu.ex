defmodule LongWeb.Components.Menu do
  @moduledoc """
  The `LongWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `LongWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import LongWeb.Components.Button, only: [button_link: 1]
