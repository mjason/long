defmodule LongWeb.Components.FileField do
  @moduledoc """
  The `LongWeb.Components.FileField` module provides a versatile and customizable component
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/file-field
  ...
  import LongWeb.Components.Progress, only: [progress: 1]
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LongWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LongWeb.Gettext, "errors", msg, opts)
    end
  end
end
