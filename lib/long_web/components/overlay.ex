defmodule LongWeb.Components.Overlay do
  @moduledoc """
  The `LongWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `LongWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
