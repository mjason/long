defmodule LongWeb.Components.CheckboxCard do
  @moduledoc """
  The `LongWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
