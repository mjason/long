defmodule LongWeb.Components.CheckboxField do
  @moduledoc """
  LongWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
