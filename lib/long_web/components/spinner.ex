defmodule LongWeb.Components.Spinner do
  @moduledoc """
  The `LongWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `LongWeb.Components.Spinner` module enables developers to provide
