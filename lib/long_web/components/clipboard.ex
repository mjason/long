defmodule LongWeb.Components.Clipboard do
  @moduledoc """
  The `LongWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
