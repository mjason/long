defmodule LongWeb.Components.Alert do
  @moduledoc """
  LongWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
